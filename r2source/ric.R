...
list2 <- list(
  ...
  , "EXS1.DE" = list("name" = "iShares Core DAX UCITS ETF (DE) EUR (Acc)", "src" = "yahoo")
  ...
  , "IQSA.DE" = list("name" = "Invesco Global Active ESG Equity UCITS ETF USD Acc", "src" = "yahoo")
  , "IBCZ.DE" = list("name" = "iShares STOXX World Equity Multifactor UCITS ETF USD (Acc)", "src" = "yahoo")
  ...
  #, "ASME.DE" = list("name" = "ASML Holding N.V.", "src" = "yahoo")
  ...
  #, "ERAG.SG" = list("name" = "Ernst Russ AG", "src" = "yahoo")
  ...
  , "2PP.DE" = list("name" = "PayPal Holdings, Inc.", "src" = "yahoo")
  , "RHM.DE" = list("name" = "Rheinmetall AG", "src" = "yahoo")
