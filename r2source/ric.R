...
list2 <- list(
  ...
  , "IE00BJQRDN15.SG" = list("name" = "Invesco Quantitative Strategies ESG Global Equity Multi-Factor (Acc)", "src" = "yahoo")
  ...
  , "IE00BKZGB098.SG" = list("name" = "HSBC Multi-Factor Worldwide Equity (Dist)", "src" = "yahoo")
